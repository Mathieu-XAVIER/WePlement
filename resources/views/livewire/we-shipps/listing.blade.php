<div class="flex">
    ...
    <div class="w-3/4 py-12">
        <div class="flex justify-between">
            ...
            <a wire:click="toggleCreateForm"> Ajouter</a>
        </div>
            ...
            @foreach($weShipps as $weShipp)
                <div class="w-1/4 px-2 mb-8">
                    <div class="border p-6 rounded-lg bg-gray-100">
                        <div class="bg-[#399B7A] text-white rounded-full p-1 mb-2 leading-relaxed text-sm inline-block px-4">
                            Livraison : 14-16 mai
                        </div>
                        ...
                        <a href="#" class="bg-black text-white rounded-full p-1 text-center text-sm inline-block px-2 mt-3">
                            Voir le détails
                        </a>
                    </div>
                </div>
